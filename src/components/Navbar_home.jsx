...
const navItems = [
  { name: "Dashboard", path: "/dashboard", outerWidth: "121px", innerWidth: "97px" },
...
const Navbar = () => {
  ...
  <div className="max-w-screen-2xl mx-auto px-2 sm:px-4 lg:px-8 flex items-center justify-between min-h-16 gap-y-2 md:gap-y-0">
        {/* JobHunt Logo */}
  ...
  <div className="hidden xl:flex flex-1 items-center justify-center gap-1 md:gap-2 lg:gap-4 whitespace-nowrap flex-shrink">
          {navItems.map((item, idx) => (
            <Link
              key={idx}
              to={item.path}
              className="px-2 md:px-3 py-2 rounded-md text-xs md:text-sm font-medium text-gray-700 hover:bg-gray-100 transition min-w-0 truncate text-center"
  ...
  <div className="hidden md:flex flex-shrink-0 items-center flex-row gap-2 ml-2">
          <button className="px-4 py-2 text-sm font-medium text-[#1B1C1C] border border-[#1B1C1C] rounded-lg hover:bg-[#1B1C1C] hover:text-white transition">Login</button>
          <button className="px-4 py-2 text-sm font-medium text-white bg-[#1B1C1C] border rounded-lg hover:bg-white hover:border-[#1B1C1C] hover:text-[#1B1C1C] transition">Get Started</button>
        </div>
        {/* Mobile Hamburger */}
        <div className="flex md:hidden">
          <button onClick={() => setMobileOpen(!mobileOpen)} className="inline-flex items-center justify-center p-2 rounded-md text-[#1B1C1C] hover:bg-gray-100 focus:outline-none">

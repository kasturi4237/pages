...
export default function HomePage() {
  ...
  return (
   <div className="flex flex-col items-center w-full max-w-[440px] sm:max-w-full min-h-[6484px] sm:min-h-screen bg-white mx-auto px-4 sm:px-6 md:px-10 xl:px-[40px] pt-24 sm:pt-[120px] xl:pt-[140px] gap-10 font-['Manrope'] z-0 scroll-smooth">
      ...
      {/* Header */}
    <header className="fixed top-0 left-0 w-full h-[56px] sm:h-[100px] flex justify-center items-center px-6 sm:px-10 xl:px-[40px] bg-white z-[10] shadow-[0px_1px_3px_rgba(0,0,0,0.3),0px_4px_8px_3px_rgba(0,0,0,0.15)]">
  <div className="flex items-center justify-between w-full max-w-[1728px] h-full">

    {/* Logo */}
    <div className="text-[24px] sm:text-[28px] xl:text-[32px] leading-[40px] sm:leading-[52px] font-extrabold text-[#A10091] font-['Manrope']">
      JobHunt
    </div>

    {/* Nav Links - Desktop Only */}
    <nav className="hidden lg:flex justify-center items-center gap-4 md:gap-6 xl:gap-[40px] text-[16px] md:text-[18px] font-['DM_Sans'] tracking-[0.5px]">
      <Link to="/" className="px-[12px] py-[8px] font-medium text-[#AA1299]">Find a Job</Link>
      <Link to="/recruiters" className="px-[12px] py-[8px] font-medium text-[#993D6F]">Find Recruiters</Link>
      <Link to="/cv-builder" className="px-[12px] py-[8px] font-medium text-[#1B1C1E]">CV Builder</Link>
      <Link to="/job-tracker" className="px-[12px] py-[8px] font-medium text-[#1B1C1E]">Job Tracker</Link>
      <Link to="/extension" className="px-[12px] py-[8px] font-medium text-[#1B1C1E]">Extension</Link>
    </nav>
...
<section
  className="
    ...
    py-[24px]
    w-[392px] h-auto
    lg:w-[1728px] lg:h-[1122px] lg:py-[80px]
  "
>

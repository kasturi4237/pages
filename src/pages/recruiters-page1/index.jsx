...
export default function RecruitersPage() {
  ...
  return (
    ...
    >
      ...
      {/* Content wrapper with top padding to clear fixed nav */}
      <div
        className="
      ...
      >
        ...
        <main
          className="
            relative w-full max-w-[1648px]
            rounded-[20px] isolation-isolate overflow-hidden
            py-10 sm:py-14 xl:py-10
          "
          style={{
        ...
        >
          ...
          <img
            ...
            className="pointer-events-none select-none absolute bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[1728px] h-auto z-[-1]"
          />

          {/* Title */}
          <div
            className="
              flex flex-col items-center gap-8 sm:gap-10 xl:gap-20
              w-full px-4 sm:px-0
            "
          >

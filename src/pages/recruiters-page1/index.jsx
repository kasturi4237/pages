...
<path d="M6 9L12 15L18 9" stroke="#47464C" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/>
     ...
     <button className="sm:hidden flex items-center justify-center w-10 h-10 border-2 border-[#B75589] rounded">
      ...
      <div className="flex flex-col justify-between items-center
       px-[24px] pt-[88px] pb-0 gap-[40px] 
       w-[440px] h-[808px] flex-none flex-grow-0 z-0

       xl:px-[40px] xl:pt-[100px] 
       xl:w-[1728px] xl:h-[1117px] xl:flex-grow">
      ...
      <main className="relative
        ...
        py-[64px] w-[392px] h-[720px] rounded-[20px]
        isolation-isolate z-0

       xl:mt-[40px] xl:py-[40px] xl:mx-auto xl:w-[1648px] xl:h-[859px]"
    ...
    <img
     ...
     />
        ...
        <div className="
        flex flex-col justify-center items-center
        px-[16px] gap-[32px] w-[392px] h-[592px] self-stretch flex-grow-0 z-[1]

        xl:px-0 xl:gap-[80px] xl:w-[1648px] xl:h-[564px]">
  

          <div
  className="
    flex flex-col items-center p-0
    w-[360px] h-[272px] self-stretch flex-grow-0

    xl:w-[1648px] xl:h-[276px]
  "
>
         <h2 className="
  
    w-[360px] h-[192px]
    text-center font-['Manrope'] font-extrabold text-[40px] leading-[64px]
    bg-gradient-to-b from-[#1B1C1C] via-[#1B1C1C]/75 to-transparent
    text-transparent bg-clip-text self-stretch
     flex-grow-0

    xl:w-[912px] xl:font-bold xl:text-[88px] xl:leading-[96px] xl:tracking-[-0.25px]
    xl:from-[#1B1C1C] xl:via-[#1B1C1C]/75 xl:to-[#1B1C1C]/35
    xl:mx-auto
  "
>
  Find the Recruiters of your Dream Company
          ...
          {/* SPACER */}
          <div className="w-[360px] xl:w-[1648px] h-[8px] flex-none order-1 self-stretch flex-grow-0" />
  ...
  className="
    ...
    font-['DM_Sans'] font-medium text-[16px] leading-[24px] tracking-[0.25px]
    flex-none order-2 self-stretch flex-grow-0

    xl:w-[820px] xl:h-[76px]
    xl:font-['Manrope'] xl:text-[24px] xl:leading-[38px] xl:tracking-normal
    xl:mx-auto
  "
>
  ...
  className="
    flex
    flex-col items-center p-[16px] gap-[24px] 
    w-[360px] h-[288px] bg-white rounded-[8px]

    xl:flex-row xl:justify-center xl:items-center
    xl:px-[24px] xl:py-[8px] xl:gap-[48px]
    xl:w-[1200px] xl:h-[72px]
    xl:rounded-full xl:shadow-[0px_1px_3px_rgba(0,0,0,0.3),0px_4px_8px_3px_rgba(0,0,0,0.15)]
  "
>
          {/* frame 422 */}
          <div
  className="
    flex flex-col items-center p-0 gap-[16px]
    w-[328px] h-[176px] flex-grow-0

    xl:flex-row xl:items-center
    xl:w-[920px] xl:h-[56px] xl:flex-grow
  "
>
            {/* Frame 420 */}
<div
  className="
    flex flex-row justify-center items-center p-[8px] gap-[8px]
    w-[328px] h-[48px] bg-[#FBF9F9] rounded-[4px] flex-grow-0

    xl:justify-start xl:p-0 xl:bg-transparent xl:rounded-none
    xl:w-[284px] xl:h-[32px] xl:flex-grow
  "
>
  {/* company search Icon */}
...
<p
  className="
    w-[272px] h-[24px] text-center font-['DM_Sans'] font-light text-[16px] leading-[24px] tracking-[0.25px] text-[#78767D] flex items-center whitespace-nowrap
    xl:w-auto xl:h-[28px] xl:text-[18px] xl:leading-[28px] xl:tracking-[0.5px] xl:text-[#47464C] xl:flex-grow-0
  "
>
  Company Name
</p>
{/* Frame 420 end*/}
          ...
          <div className="hidden xl:block w-[2px] h-[32px] bg-[#C8C5CD] rounded-[1000px] flex-none  flex-grow-0"/>
...
>
  Location
          ...
          {/* Button */}
          {/* Button: desktop spec (first) & mobile spec (second) */}
<button onClick={handleSearch}
  className="
   
    box-border flex items-center justify-center gap-2
    w-[328px] h-[56px] px-[24px] py-[14px]
    bg-[#1B1C1C] border-2 border-[#1B1C1C]
    rounded-[4px]
    self-stretch

    
    xl:w-[200px] xl:rounded-[1000px] xl:self-auto
  "
  aria-label="Search"
>
  {/* left icon (hidden by default) */}
  <svg className="hidden w-6 h-6" aria-hidden="true">{/* ... */}</svg>

  {/* label */}
  <span className="text-[18px] leading-[28px] font-['DM_Sans'] font-medium text-white">
    Search
  </span>
